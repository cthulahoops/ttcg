...
export const LegolasBurdened: CharacterDefinition = {
  ...
  setup: async (game, seat, setupContext) => {
    const exclude =
      game.lostCard &&
      (game.lostCard.suit === "forests" || game.lostCard.suit === "shadows")
        ? game.lostCard.value
        : undefined;
  ...
  objective: {
    text: "Win both the Forests and Shadows cards matching your threat card",
    ...
    getStatus: (game, seat): ObjectiveStatus => {
      ...
      return achieveBoth(
        achieveCard(game, seat, { suit: "forests", value: seat.threatCard }),
